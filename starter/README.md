# Starter (AI Kit pre-installed)

This folder is a **starter repo**: the AI Kit is already at the root. Copy it and go.

## Use this repo in 60 seconds
...
**When to use `kit/` instead:** You already have a repo and only want to add the kit files. Copy the contents of `kit/` into your repo root.
