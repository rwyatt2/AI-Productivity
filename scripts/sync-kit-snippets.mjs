...
const FILES = [
    ...
    { src: ".cursor/rules/10-spec-package.mdc", dest: "cursor-rules-spec-package.md", title: "Cursor Rules - Plan Output (Reference)" },
    { src: ".cursor/rules/20-implementation-package.mdc", dest: "cursor-rules-implementation-package.md", title: "Cursor Rules - Agent Output (Reference)" },
    ...
    { src: ".agent/rules/10-spec-package.md", dest: "antigravity-rules-spec-package.md", title: "Antigravity Rules - Plan Output (Reference)" },
    { src: ".agent/rules/20-implementation-package.md", dest: "antigravity-rules-implementation-package.md", title: "Antigravity Rules - Agent Output (Reference)" },
