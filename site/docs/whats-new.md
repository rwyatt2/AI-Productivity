...
All notable changes to the AI Productivity Kit. Format based on [Keep a Changelog](https://keepachangelog.com/en/1.1.0/).
...
- **Docs**
  - New [Global Rules](getting-started/global-rules) page: explains Cursor Global Rules vs repo project rules, includes copy/paste global rules text and where to paste them in Cursor settings.
  - Optional "set Global Rules" section in [Install by copying](getting-started/install-by-copying).
